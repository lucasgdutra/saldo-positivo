...
export const RevenueFindManySelectSchema: z.ZodType<Prisma.RevenueSelect, Prisma.RevenueSelect> = z.object({
...
export const RevenueFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    amount: z.boolean().optional(),
    description: z.boolean().optional(),
    date: z.boolean().optional(),
...
export const RevenueFindManySchema: z.ZodType<Prisma.RevenueFindManyArgs, Prisma.RevenueFindManyArgs> = z.object({ select: RevenueFindManySelectSchema.optional(), include: z.lazy(() => RevenueIncludeObjectSchema.optional()), orderBy: z.union([RevenueOrderByWithRelationInputObjectSchema, RevenueOrderByWithRelationInputObjectSchema.array()]).optional(), where: RevenueWhereInputObjectSchema.optional(), cursor: RevenueWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RevenueScalarFieldEnumSchema, RevenueScalarFieldEnumSchema.array()]).optional() }).strict();

export const RevenueFindManyZodSchema = z.object({ select: RevenueFindManySelectSchema.optional(), include: z.lazy(() => RevenueIncludeObjectSchema.optional()), orderBy: z.union([RevenueOrderByWithRelationInputObjectSchema, RevenueOrderByWithRelationInputObjectSchema.array()]).optional(), where: RevenueWhereInputObjectSchema.optional(), cursor: RevenueWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RevenueScalarFieldEnumSchema, RevenueScalarFieldEnumSchema.array()]).optional() }).strict();