...
export const BalanceFindFirstOrThrowSelectSchema: z.ZodType<Prisma.BalanceSelect> =
	z
		.object({
...
export const BalanceFindFirstOrThrowSelectZodSchema = z
	.object({
		id: z.boolean().optional(),
		totalAmount: z.boolean().optional(),
		totalRevenues: z.boolean().optional(),
...
export const BalanceFindFirstOrThrowSchema: z.ZodType<Prisma.BalanceFindFirstOrThrowArgs> =
	z
		.object({
			select: BalanceFindFirstOrThrowSelectSchema.optional(),
		...
		.strict() as unknown as z.ZodType<Prisma.BalanceFindFirstOrThrowArgs>;

export const BalanceFindFirstOrThrowZodSchema = z
	.object({
		select: BalanceFindFirstOrThrowSelectSchema.optional(),
		include: z.lazy(() => BalanceIncludeObjectSchema.optional()),
		orderBy: z
