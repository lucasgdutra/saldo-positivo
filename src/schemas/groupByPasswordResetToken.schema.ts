...
export const PasswordResetTokenGroupBySchema = z.object({ where: PasswordResetTokenWhereInputObjectSchema.optional(), orderBy: z.union([PasswordResetTokenOrderByWithAggregationInputObjectSchema, PasswordResetTokenOrderByWithAggregationInputObjectSchema.array()]).optional(), having: PasswordResetTokenScalarWhereWithAggregatesInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), by: z.array(PasswordResetTokenScalarFieldEnumSchema), _count: z.union([ z.literal(true), PasswordResetTokenCountAggregateInputObjectSchema ]).optional(), _min: PasswordResetTokenMinAggregateInputObjectSchema.optional(), _max: PasswordResetTokenMaxAggregateInputObjectSchema.optional() })