...
export const BalanceAggregateSchema = z.object({ orderBy: z.union([BalanceOrderByWithRelationInputObjectSchema, BalanceOrderByWithRelationInputObjectSchema.array()]).optional(), where: BalanceWhereInputObjectSchema.optional(), cursor: BalanceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), _count: z.union([ z.literal(true), BalanceCountAggregateInputObjectSchema ]).optional(), _min: BalanceMinAggregateInputObjectSchema.optional(), _max: BalanceMaxAggregateInputObjectSchema.optional(), _avg: BalanceAvgAggregateInputObjectSchema.optional(), _sum: BalanceSumAggregateInputObjectSchema.optional() })