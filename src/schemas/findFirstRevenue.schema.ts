...
export const RevenueFindFirstSelectSchema: z.ZodType<Prisma.RevenueSelect> = z
	.object({
...
export const RevenueFindFirstSelectZodSchema = z
	.object({
		id: z.boolean().optional(),
		amount: z.boolean().optional(),
		description: z.boolean().optional(),
...
export const RevenueFindFirstSchema: z.ZodType<Prisma.RevenueFindFirstArgs> = z
	.object({
		select: RevenueFindFirstSelectSchema.optional(),
	...
	.strict() as unknown as z.ZodType<Prisma.RevenueFindFirstArgs>;

export const RevenueFindFirstZodSchema = z
	.object({
		select: RevenueFindFirstSelectSchema.optional(),
		include: z.lazy(() => RevenueIncludeObjectSchema.optional()),
		orderBy: z
