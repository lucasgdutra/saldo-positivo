...
export const RevenueGroupBySchema = z.object({
	where: RevenueWhereInputObjectSchema.optional(),
	orderBy: z
		.union([
			RevenueOrderByWithAggregationInputObjectSchema,
			RevenueOrderByWithAggregationInputObjectSchema.array(),
		])
		.optional(),
	having: RevenueScalarWhereWithAggregatesInputObjectSchema.optional(),
	take: z.number().optional(),
	skip: z.number().optional(),
	by: z.array(RevenueScalarFieldEnumSchema),
	_count: z
