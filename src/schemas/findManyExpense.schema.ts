...
export const ExpenseFindManySelectSchema: z.ZodType<Prisma.ExpenseSelect> = z.object({
...
export const ExpenseFindManySchema: z.ZodType<Prisma.ExpenseFindManyArgs> = z.object({ select: ExpenseFindManySelectSchema.optional(), include: z.lazy(() => ExpenseIncludeObjectSchema.optional()), orderBy: z.union([ExpenseOrderByWithRelationInputObjectSchema, ExpenseOrderByWithRelationInputObjectSchema.array()]).optional(), where: ExpenseWhereInputObjectSchema.optional(), cursor: ExpenseWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ExpenseScalarFieldEnumSchema, ExpenseScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ExpenseFindManyArgs>;
