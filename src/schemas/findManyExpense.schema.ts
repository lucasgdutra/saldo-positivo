...
export const ExpenseFindManySelectSchema: z.ZodType<Prisma.ExpenseSelect> = z
	.object({
...
export const ExpenseFindManySelectZodSchema = z
	.object({
		id: z.boolean().optional(),
		amount: z.boolean().optional(),
		description: z.boolean().optional(),
...
export const ExpenseFindManySchema: z.ZodType<Prisma.ExpenseFindManyArgs> = z
	.object({
		select: ExpenseFindManySelectSchema.optional(),
	...
	.strict() as unknown as z.ZodType<Prisma.ExpenseFindManyArgs>;

export const ExpenseFindManyZodSchema = z
	.object({
		select: ExpenseFindManySelectSchema.optional(),
		include: z.lazy(() => ExpenseIncludeObjectSchema.optional()),
		orderBy: z
