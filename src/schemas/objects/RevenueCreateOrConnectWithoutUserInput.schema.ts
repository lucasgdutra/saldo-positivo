...
export const RevenueCreateOrConnectWithoutUserInputObjectSchema: z.ZodType<
	Prisma.RevenueCreateOrConnectWithoutUserInput,
	Prisma.RevenueCreateOrConnectWithoutUserInput
> = z
	.object({
	...
	.strict();
export const RevenueCreateOrConnectWithoutUserInputObjectZodSchema = z
	.object({
		where: z.lazy(() => RevenueWhereUniqueInputObjectSchema),
		create: z.union([
			z.lazy(() => RevenueCreateWithoutUserInputObjectSchema),
