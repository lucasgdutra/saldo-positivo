...
const makeSchema = (): z.ZodObject<any> => z.object({
  ...
  upsert: z.union([z.lazy(() => CategoryUpsertWithWhereUniqueWithoutUserInputObjectSchema), z.lazy(() => CategoryUpsertWithWhereUniqueWithoutUserInputObjectSchema).array()]).optional(),
  ...
  update: z.union([z.lazy(() => CategoryUpdateWithWhereUniqueWithoutUserInputObjectSchema), z.lazy(() => CategoryUpdateWithWhereUniqueWithoutUserInputObjectSchema).array()]).optional(),
  updateMany: z.union([z.lazy(() => CategoryUpdateManyWithWhereWithoutUserInputObjectSchema), z.lazy(() => CategoryUpdateManyWithWhereWithoutUserInputObjectSchema).array()]).optional(),
...
export const CategoryUncheckedUpdateManyWithoutUserNestedInputObjectSchema: z.ZodType<Prisma.CategoryUncheckedUpdateManyWithoutUserNestedInput> = makeSchema() as unknown as z.ZodType<Prisma.CategoryUncheckedUpdateManyWithoutUserNestedInput>;
export const CategoryUncheckedUpdateManyWithoutUserNestedInputObjectZodSchema = makeSchema();
