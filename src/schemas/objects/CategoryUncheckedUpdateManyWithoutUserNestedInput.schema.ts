	...
	z
		.object({
			...
			upsert: z
				.union([
					z.lazy(
						() => CategoryUpsertWithWhereUniqueWithoutUserInputObjectSchema,
					),
					z
						.lazy(
							() => CategoryUpsertWithWhereUniqueWithoutUserInputObjectSchema,
			...
			update: z
				.union([
					z.lazy(
						() => CategoryUpdateWithWhereUniqueWithoutUserInputObjectSchema,
					),
					z
						.lazy(
							() => CategoryUpdateWithWhereUniqueWithoutUserInputObjectSchema,
		...
		.strict();
export const CategoryUncheckedUpdateManyWithoutUserNestedInputObjectSchema: z.ZodType<Prisma.CategoryUncheckedUpdateManyWithoutUserNestedInput> =
	makeSchema() as unknown as z.ZodType<Prisma.CategoryUncheckedUpdateManyWithoutUserNestedInput>;
export const CategoryUncheckedUpdateManyWithoutUserNestedInputObjectZodSchema =
	makeSchema();
