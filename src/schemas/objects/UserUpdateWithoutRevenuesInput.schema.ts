...
export const UserUpdateWithoutRevenuesInputObjectSchema: z.ZodType<
	Prisma.UserUpdateWithoutRevenuesInput,
	Prisma.UserUpdateWithoutRevenuesInput
> = z
	.object({
		email: z
	...
	.strict();
export const UserUpdateWithoutRevenuesInputObjectZodSchema = z
	.object({
		email: z
			.union([
				z.string(),
