...
export const UserCreateWithoutCategoriesInputObjectSchema: z.ZodType<Prisma.UserCreateWithoutCategoriesInput, Prisma.UserCreateWithoutCategoriesInput> = z.object({
...
export const UserCreateWithoutCategoriesInputObjectZodSchema = z.object({
  id: z.string().optional(),
  email: z.string(),
  password: z.string(),
  name: z.string(),
