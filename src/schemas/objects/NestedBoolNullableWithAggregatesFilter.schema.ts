...
export const NestedBoolNullableWithAggregatesFilterObjectSchema: z.ZodType<
	Prisma.NestedBoolNullableWithAggregatesFilter,
	Prisma.NestedBoolNullableWithAggregatesFilter
> = z
	.object({
	...
	.strict();
export const NestedBoolNullableWithAggregatesFilterObjectZodSchema = z
	.object({
		equals: z.boolean().nullish(),
		not: z
			.union([
