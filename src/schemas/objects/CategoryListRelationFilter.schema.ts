...
export const CategoryListRelationFilterObjectSchema: z.ZodType<Prisma.CategoryListRelationFilter, Prisma.CategoryListRelationFilter> = z.object({
...
export const CategoryListRelationFilterObjectZodSchema = z.object({
  every: z.lazy(() => CategoryWhereInputObjectSchema).optional(),
  some: z.lazy(() => CategoryWhereInputObjectSchema).optional(),
  none: z.lazy(() => CategoryWhereInputObjectSchema).optional()
}).strict();
