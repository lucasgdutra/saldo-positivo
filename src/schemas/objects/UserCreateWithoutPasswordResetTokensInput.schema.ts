...
export const UserCreateWithoutPasswordResetTokensInputObjectSchema: z.ZodType<Prisma.UserCreateWithoutPasswordResetTokensInput, Prisma.UserCreateWithoutPasswordResetTokensInput> = z.object({
...
export const UserCreateWithoutPasswordResetTokensInputObjectZodSchema = z.object({
  id: z.string().optional(),
  email: z.string(),
  password: z.string(),
  name: z.string(),
