...
export const UserUpdateOneRequiredWithoutRevenuesNestedInputObjectSchema: z.ZodType<Prisma.UserUpdateOneRequiredWithoutRevenuesNestedInput, Prisma.UserUpdateOneRequiredWithoutRevenuesNestedInput> = z.object({
...
export const UserUpdateOneRequiredWithoutRevenuesNestedInputObjectZodSchema = z.object({
  create: z.union([z.lazy(() => UserCreateWithoutRevenuesInputObjectSchema), z.lazy(() => UserUncheckedCreateWithoutRevenuesInputObjectSchema)]).optional(),
  connectOrCreate: z.lazy(() => UserCreateOrConnectWithoutRevenuesInputObjectSchema).optional(),
  upsert: z.lazy(() => UserUpsertWithoutRevenuesInputObjectSchema).optional(),
  connect: z.lazy(() => UserWhereUniqueInputObjectSchema).optional(),
