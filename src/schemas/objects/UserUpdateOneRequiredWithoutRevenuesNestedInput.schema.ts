	...
	z
		.object({
			...
			connectOrCreate: z
				...
				.optional(),
			upsert: z
				.lazy(() => UserUpsertWithoutRevenuesInputObjectSchema)
				.optional(),
			connect: z.lazy(() => UserWhereUniqueInputObjectSchema).optional(),
			update: z
				.union([
					z.lazy(
						() => UserUpdateToOneWithWhereWithoutRevenuesInputObjectSchema,
					),
		...
		.strict();
export const UserUpdateOneRequiredWithoutRevenuesNestedInputObjectSchema: z.ZodType<Prisma.UserUpdateOneRequiredWithoutRevenuesNestedInput> =
	makeSchema() as unknown as z.ZodType<Prisma.UserUpdateOneRequiredWithoutRevenuesNestedInput>;
export const UserUpdateOneRequiredWithoutRevenuesNestedInputObjectZodSchema =
	makeSchema();
