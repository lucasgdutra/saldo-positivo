	...
	z
		.object({
			...
			revenues: z
				...
				.optional(),
			balance: z
				.lazy(() => BalanceUpdateOneWithoutUserNestedInputObjectSchema)
				.optional(),
		...
		.strict();
export const UserUpdateWithoutExpensesInputObjectSchema: z.ZodType<Prisma.UserUpdateWithoutExpensesInput> =
	makeSchema() as unknown as z.ZodType<Prisma.UserUpdateWithoutExpensesInput>;
export const UserUpdateWithoutExpensesInputObjectZodSchema = makeSchema();
