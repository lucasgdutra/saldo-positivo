...
export const CategoryCreateNestedManyWithoutUserInputObjectSchema: z.ZodType<
	Prisma.CategoryCreateNestedManyWithoutUserInput,
	Prisma.CategoryCreateNestedManyWithoutUserInput
> = z
	.object({
		create: z
	...
	.strict();
export const CategoryCreateNestedManyWithoutUserInputObjectZodSchema = z
	.object({
		create: z
			.union([
				z.lazy(() => CategoryCreateWithoutUserInputObjectSchema),
