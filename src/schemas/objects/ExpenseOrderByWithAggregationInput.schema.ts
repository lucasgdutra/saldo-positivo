	...
	z
		.object({
			...
			_count: z
				...
				.optional(),
			_avg: z
				.lazy(() => ExpenseAvgOrderByAggregateInputObjectSchema)
				.optional(),
			_max: z
				.lazy(() => ExpenseMaxOrderByAggregateInputObjectSchema)
				.optional(),
			_min: z
				.lazy(() => ExpenseMinOrderByAggregateInputObjectSchema)
				.optional(),
			_sum: z
				.lazy(() => ExpenseSumOrderByAggregateInputObjectSchema)
				.optional(),
		})
		.strict();
export const ExpenseOrderByWithAggregationInputObjectSchema: z.ZodType<Prisma.ExpenseOrderByWithAggregationInput> =
	makeSchema() as unknown as z.ZodType<Prisma.ExpenseOrderByWithAggregationInput>;
