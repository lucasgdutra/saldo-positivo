...
export const PasswordResetTokenOrderByWithAggregationInputObjectSchema: z.ZodType<
...
> = z
	...
	.strict();
export const PasswordResetTokenOrderByWithAggregationInputObjectZodSchema = z
	.object({
		id: SortOrderSchema.optional(),
		token: SortOrderSchema.optional(),
		userId: SortOrderSchema.optional(),
