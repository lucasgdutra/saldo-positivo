	...
	z
		.object({
			...
			connectOrCreate: z
				...
				.optional(),
			upsert: z
				.lazy(() => UserUpsertWithoutCategoriesInputObjectSchema)
				.optional(),
			connect: z.lazy(() => UserWhereUniqueInputObjectSchema).optional(),
			update: z
				.union([
					z.lazy(
						() => UserUpdateToOneWithWhereWithoutCategoriesInputObjectSchema,
					),
		...
		.strict();
export const UserUpdateOneRequiredWithoutCategoriesNestedInputObjectSchema: z.ZodType<Prisma.UserUpdateOneRequiredWithoutCategoriesNestedInput> =
	makeSchema() as unknown as z.ZodType<Prisma.UserUpdateOneRequiredWithoutCategoriesNestedInput>;
export const UserUpdateOneRequiredWithoutCategoriesNestedInputObjectZodSchema =
	makeSchema();
