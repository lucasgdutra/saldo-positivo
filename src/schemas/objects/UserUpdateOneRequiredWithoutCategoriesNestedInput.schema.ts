...
export const UserUpdateOneRequiredWithoutCategoriesNestedInputObjectSchema: z.ZodType<Prisma.UserUpdateOneRequiredWithoutCategoriesNestedInput, Prisma.UserUpdateOneRequiredWithoutCategoriesNestedInput> = z.object({
...
export const UserUpdateOneRequiredWithoutCategoriesNestedInputObjectZodSchema = z.object({
  create: z.union([z.lazy(() => UserCreateWithoutCategoriesInputObjectSchema), z.lazy(() => UserUncheckedCreateWithoutCategoriesInputObjectSchema)]).optional(),
  connectOrCreate: z.lazy(() => UserCreateOrConnectWithoutCategoriesInputObjectSchema).optional(),
  upsert: z.lazy(() => UserUpsertWithoutCategoriesInputObjectSchema).optional(),
  connect: z.lazy(() => UserWhereUniqueInputObjectSchema).optional(),
