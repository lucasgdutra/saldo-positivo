...
export const BalanceUncheckedUpdateOneWithoutUserNestedInputObjectSchema: z.ZodType<
	Prisma.BalanceUncheckedUpdateOneWithoutUserNestedInput,
	Prisma.BalanceUncheckedUpdateOneWithoutUserNestedInput
> = z
	.object({
		create: z
	...
	.strict();
export const BalanceUncheckedUpdateOneWithoutUserNestedInputObjectZodSchema = z
	.object({
		create: z
			.union([
				z.lazy(() => BalanceCreateWithoutUserInputObjectSchema),
