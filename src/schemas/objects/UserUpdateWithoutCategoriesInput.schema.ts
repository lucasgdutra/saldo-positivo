...
export const UserUpdateWithoutCategoriesInputObjectSchema: z.ZodType<Prisma.UserUpdateWithoutCategoriesInput, Prisma.UserUpdateWithoutCategoriesInput> = z.object({
...
export const UserUpdateWithoutCategoriesInputObjectZodSchema = z.object({
  email: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  password: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  name: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  salaryRange: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).nullish(),
