...
export const CategoryCreateManyUserInputEnvelopeObjectSchema: z.ZodType<
	Prisma.CategoryCreateManyUserInputEnvelope,
	Prisma.CategoryCreateManyUserInputEnvelope
> = z
	.object({
		data: z.union([
	...
	.strict();
export const CategoryCreateManyUserInputEnvelopeObjectZodSchema = z
	.object({
		data: z.union([
			z.lazy(() => CategoryCreateManyUserInputObjectSchema),
			z.lazy(() => CategoryCreateManyUserInputObjectSchema).array(),
