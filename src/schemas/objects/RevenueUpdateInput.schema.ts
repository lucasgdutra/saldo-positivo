...
export const RevenueUpdateInputObjectSchema: z.ZodType<Prisma.RevenueUpdateInput, Prisma.RevenueUpdateInput> = z.object({
  ...
  user: z.lazy(() => UserUpdateOneRequiredWithoutRevenuesNestedInputObjectSchema).optional()
}).strict();
export const RevenueUpdateInputObjectZodSchema = z.object({
  amount: z.union([z.number(), z.lazy(() => DecimalFieldUpdateOperationsInputObjectSchema)]).optional(),
  description: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).nullish(),
  date: z.union([z.date(), z.lazy(() => DateTimeFieldUpdateOperationsInputObjectSchema)]).optional(),
  user: z.lazy(() => UserUpdateOneRequiredWithoutRevenuesNestedInputObjectSchema).optional()
