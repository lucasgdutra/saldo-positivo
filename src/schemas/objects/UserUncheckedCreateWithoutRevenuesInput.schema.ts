...
export const UserUncheckedCreateWithoutRevenuesInputObjectSchema: z.ZodType<
	Prisma.UserUncheckedCreateWithoutRevenuesInput,
	Prisma.UserUncheckedCreateWithoutRevenuesInput
> = z
	.object({
	...
	.strict();
export const UserUncheckedCreateWithoutRevenuesInputObjectZodSchema = z
	.object({
		id: z.string().optional(),
		email: z.string(),
		password: z.string(),
