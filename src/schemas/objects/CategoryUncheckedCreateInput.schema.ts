...
export const CategoryUncheckedCreateInputObjectSchema: z.ZodType<Prisma.CategoryUncheckedCreateInput, Prisma.CategoryUncheckedCreateInput> = z.object({
...
export const CategoryUncheckedCreateInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  userId: z.string(),
  createdAt: z.date().optional(),
