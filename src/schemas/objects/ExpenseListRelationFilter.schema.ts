...
export const ExpenseListRelationFilterObjectSchema: z.ZodType<Prisma.ExpenseListRelationFilter, Prisma.ExpenseListRelationFilter> = z.object({
...
export const ExpenseListRelationFilterObjectZodSchema = z.object({
  every: z.lazy(() => ExpenseWhereInputObjectSchema).optional(),
  some: z.lazy(() => ExpenseWhereInputObjectSchema).optional(),
  none: z.lazy(() => ExpenseWhereInputObjectSchema).optional()
}).strict();
