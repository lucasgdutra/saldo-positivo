...
export const UserCreateWithoutRevenuesInputObjectSchema: z.ZodType<Prisma.UserCreateWithoutRevenuesInput, Prisma.UserCreateWithoutRevenuesInput> = z.object({
...
export const UserCreateWithoutRevenuesInputObjectZodSchema = z.object({
  id: z.string().optional(),
  email: z.string(),
  password: z.string(),
  name: z.string(),
