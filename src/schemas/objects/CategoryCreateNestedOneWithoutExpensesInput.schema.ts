...
const makeSchema = (): z.ZodObject<any> =>
	z
		...
		.strict();
export const CategoryCreateNestedOneWithoutExpensesInputObjectSchema: z.ZodType<Prisma.CategoryCreateNestedOneWithoutExpensesInput> =
	makeSchema() as unknown as z.ZodType<Prisma.CategoryCreateNestedOneWithoutExpensesInput>;
export const CategoryCreateNestedOneWithoutExpensesInputObjectZodSchema =
	makeSchema();
