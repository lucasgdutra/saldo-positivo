...
export const CategoryCreateNestedOneWithoutExpensesInputObjectSchema: z.ZodType<Prisma.CategoryCreateNestedOneWithoutExpensesInput, Prisma.CategoryCreateNestedOneWithoutExpensesInput> = z.object({
...
export const CategoryCreateNestedOneWithoutExpensesInputObjectZodSchema = z.object({
  create: z.union([z.lazy(() => CategoryCreateWithoutExpensesInputObjectSchema), z.lazy(() => CategoryUncheckedCreateWithoutExpensesInputObjectSchema)]).optional(),
  connectOrCreate: z.lazy(() => CategoryCreateOrConnectWithoutExpensesInputObjectSchema).optional(),
  connect: z.lazy(() => CategoryWhereUniqueInputObjectSchema).optional()
}).strict();
