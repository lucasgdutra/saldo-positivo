	...
	z
		.object({
			...
			upsert: z
				.union([
					z.lazy(
						() => ExpenseUpsertWithWhereUniqueWithoutUserInputObjectSchema,
					),
					z
						.lazy(
							() => ExpenseUpsertWithWhereUniqueWithoutUserInputObjectSchema,
			...
			update: z
				.union([
					z.lazy(
						() => ExpenseUpdateWithWhereUniqueWithoutUserInputObjectSchema,
					),
					z
						.lazy(
							() => ExpenseUpdateWithWhereUniqueWithoutUserInputObjectSchema,
		...
		.strict();
export const ExpenseUncheckedUpdateManyWithoutUserNestedInputObjectSchema: z.ZodType<Prisma.ExpenseUncheckedUpdateManyWithoutUserNestedInput> =
	makeSchema() as unknown as z.ZodType<Prisma.ExpenseUncheckedUpdateManyWithoutUserNestedInput>;
export const ExpenseUncheckedUpdateManyWithoutUserNestedInputObjectZodSchema =
	makeSchema();
