...
export const UserUpdateOneRequiredWithoutBalanceNestedInputObjectSchema: z.ZodType<
	Prisma.UserUpdateOneRequiredWithoutBalanceNestedInput,
	Prisma.UserUpdateOneRequiredWithoutBalanceNestedInput
> = z
	.object({
		create: z
	...
	.strict();
export const UserUpdateOneRequiredWithoutBalanceNestedInputObjectZodSchema = z
	.object({
		create: z
			.union([
				z.lazy(() => UserCreateWithoutBalanceInputObjectSchema),
