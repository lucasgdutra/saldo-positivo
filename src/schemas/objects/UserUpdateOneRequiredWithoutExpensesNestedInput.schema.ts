	...
	z
		.object({
			...
			update: z
				.union([
					z.lazy(
						() => UserUpdateToOneWithWhereWithoutExpensesInputObjectSchema,
					),
		...
		.strict();
export const UserUpdateOneRequiredWithoutExpensesNestedInputObjectSchema: z.ZodType<Prisma.UserUpdateOneRequiredWithoutExpensesNestedInput> =
	makeSchema() as unknown as z.ZodType<Prisma.UserUpdateOneRequiredWithoutExpensesNestedInput>;
export const UserUpdateOneRequiredWithoutExpensesNestedInputObjectZodSchema =
	makeSchema();
