...
export const UserUpdateOneRequiredWithoutExpensesNestedInputObjectSchema: z.ZodType<
	Prisma.UserUpdateOneRequiredWithoutExpensesNestedInput,
	Prisma.UserUpdateOneRequiredWithoutExpensesNestedInput
> = z
	.object({
		create: z
		...
		update: z
			.union([
				z.lazy(() => UserUpdateToOneWithWhereWithoutExpensesInputObjectSchema),
	...
	.strict();
export const UserUpdateOneRequiredWithoutExpensesNestedInputObjectZodSchema = z
	.object({
		create: z
			.union([
				z.lazy(() => UserCreateWithoutExpensesInputObjectSchema),
