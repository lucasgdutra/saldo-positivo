...
export const UserUpdateOneRequiredWithoutExpensesNestedInputObjectSchema: z.ZodType<Prisma.UserUpdateOneRequiredWithoutExpensesNestedInput, Prisma.UserUpdateOneRequiredWithoutExpensesNestedInput> = z.object({
...
export const UserUpdateOneRequiredWithoutExpensesNestedInputObjectZodSchema = z.object({
  create: z.union([z.lazy(() => UserCreateWithoutExpensesInputObjectSchema), z.lazy(() => UserUncheckedCreateWithoutExpensesInputObjectSchema)]).optional(),
  connectOrCreate: z.lazy(() => UserCreateOrConnectWithoutExpensesInputObjectSchema).optional(),
  upsert: z.lazy(() => UserUpsertWithoutExpensesInputObjectSchema).optional(),
  connect: z.lazy(() => UserWhereUniqueInputObjectSchema).optional(),
