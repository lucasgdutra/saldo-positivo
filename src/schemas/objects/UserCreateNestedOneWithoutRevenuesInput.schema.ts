...
export const UserCreateNestedOneWithoutRevenuesInputObjectSchema: z.ZodType<
	Prisma.UserCreateNestedOneWithoutRevenuesInput,
	Prisma.UserCreateNestedOneWithoutRevenuesInput
> = z
	.object({
		create: z
	...
	.strict();
export const UserCreateNestedOneWithoutRevenuesInputObjectZodSchema = z
	.object({
		create: z
			.union([
				z.lazy(() => UserCreateWithoutRevenuesInputObjectSchema),
