...
export const UserCreateNestedOneWithoutExpensesInputObjectSchema: z.ZodType<
	Prisma.UserCreateNestedOneWithoutExpensesInput,
	Prisma.UserCreateNestedOneWithoutExpensesInput
> = z
	.object({
		create: z
	...
	.strict();
export const UserCreateNestedOneWithoutExpensesInputObjectZodSchema = z
	.object({
		create: z
			.union([
				z.lazy(() => UserCreateWithoutExpensesInputObjectSchema),
