...
export const RevenueUncheckedUpdateManyWithoutUserNestedInputObjectSchema: z.ZodType<
	Prisma.RevenueUncheckedUpdateManyWithoutUserNestedInput,
	Prisma.RevenueUncheckedUpdateManyWithoutUserNestedInput
> = z
	.object({
		create: z
		...
		upsert: z
			.union([
				z.lazy(() => RevenueUpsertWithWhereUniqueWithoutUserInputObjectSchema),
				z
					.lazy(() => RevenueUpsertWithWhereUniqueWithoutUserInputObjectSchema)
					.array(),
			])
			.optional(),
		createMany: z
		...
		update: z
			.union([
				z.lazy(() => RevenueUpdateWithWhereUniqueWithoutUserInputObjectSchema),
				z
					.lazy(() => RevenueUpdateWithWhereUniqueWithoutUserInputObjectSchema)
					.array(),
			])
			.optional(),
		updateMany: z
			.union([
				z.lazy(() => RevenueUpdateManyWithWhereWithoutUserInputObjectSchema),
				z
					.lazy(() => RevenueUpdateManyWithWhereWithoutUserInputObjectSchema)
					.array(),
			])
			.optional(),
		deleteMany: z
			.union([
				z.lazy(() => RevenueScalarWhereInputObjectSchema),
				z.lazy(() => RevenueScalarWhereInputObjectSchema).array(),
			])
			.optional(),
	})
	.strict();
export const RevenueUncheckedUpdateManyWithoutUserNestedInputObjectZodSchema = z
	.object({
		create: z
			.union([
				z.lazy(() => RevenueCreateWithoutUserInputObjectSchema),
