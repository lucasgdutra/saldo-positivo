	...
	z
		.object({
			...
			upsert: z
				.union([
					z.lazy(
						() => RevenueUpsertWithWhereUniqueWithoutUserInputObjectSchema,
					),
					z
						.lazy(
							() => RevenueUpsertWithWhereUniqueWithoutUserInputObjectSchema,
			...
			update: z
				.union([
					z.lazy(
						() => RevenueUpdateWithWhereUniqueWithoutUserInputObjectSchema,
					),
					z
						.lazy(
							() => RevenueUpdateWithWhereUniqueWithoutUserInputObjectSchema,
		...
		.strict();
export const RevenueUncheckedUpdateManyWithoutUserNestedInputObjectSchema: z.ZodType<Prisma.RevenueUncheckedUpdateManyWithoutUserNestedInput> =
	makeSchema() as unknown as z.ZodType<Prisma.RevenueUncheckedUpdateManyWithoutUserNestedInput>;
export const RevenueUncheckedUpdateManyWithoutUserNestedInputObjectZodSchema =
	makeSchema();
