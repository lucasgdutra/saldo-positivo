...
export const BalanceCreateInputObjectSchema: z.ZodType<Prisma.BalanceCreateInput, Prisma.BalanceCreateInput> = z.object({
...
export const BalanceCreateInputObjectZodSchema = z.object({
  id: z.string().optional(),
  totalAmount: z.number(),
  totalRevenues: z.number(),
  totalExpenses: z.number(),
