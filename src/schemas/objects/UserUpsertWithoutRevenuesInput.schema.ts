...
export const UserUpsertWithoutRevenuesInputObjectSchema: z.ZodType<Prisma.UserUpsertWithoutRevenuesInput, Prisma.UserUpsertWithoutRevenuesInput> = z.object({
  update: z.union([z.lazy(() => UserUpdateWithoutRevenuesInputObjectSchema), z.lazy(() => UserUncheckedUpdateWithoutRevenuesInputObjectSchema)]),
...
export const UserUpsertWithoutRevenuesInputObjectZodSchema = z.object({
  update: z.union([z.lazy(() => UserUpdateWithoutRevenuesInputObjectSchema), z.lazy(() => UserUncheckedUpdateWithoutRevenuesInputObjectSchema)]),
  create: z.union([z.lazy(() => UserCreateWithoutRevenuesInputObjectSchema), z.lazy(() => UserUncheckedCreateWithoutRevenuesInputObjectSchema)]),
  where: z.lazy(() => UserWhereInputObjectSchema).optional()
}).strict();
