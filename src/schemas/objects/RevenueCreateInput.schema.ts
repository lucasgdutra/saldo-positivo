...
export const RevenueCreateInputObjectSchema: z.ZodType<Prisma.RevenueCreateInput, Prisma.RevenueCreateInput> = z.object({
...
export const RevenueCreateInputObjectZodSchema = z.object({
  id: z.string().optional(),
  amount: z.number(),
  description: z.string().nullish(),
  date: z.date(),
