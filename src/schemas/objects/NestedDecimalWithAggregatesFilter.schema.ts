...
export const NestedDecimalWithAggregatesFilterObjectSchema: z.ZodType<
	Prisma.NestedDecimalWithAggregatesFilter,
	Prisma.NestedDecimalWithAggregatesFilter
> = z
	.object({
	...
	.strict();
export const NestedDecimalWithAggregatesFilterObjectZodSchema = z
	.object({
		equals: z.number().optional(),
		in: z.number().array().optional(),
		notIn: z.number().array().optional(),
