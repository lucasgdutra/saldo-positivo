...
export const UserUncheckedCreateWithoutBalanceInputObjectSchema: z.ZodType<
	Prisma.UserUncheckedCreateWithoutBalanceInput,
	Prisma.UserUncheckedCreateWithoutBalanceInput
> = z
	.object({
	...
	.strict();
export const UserUncheckedCreateWithoutBalanceInputObjectZodSchema = z
	.object({
		id: z.string().optional(),
		email: z.string(),
		password: z.string(),
