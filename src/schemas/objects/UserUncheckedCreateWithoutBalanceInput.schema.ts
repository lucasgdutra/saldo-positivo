...
export const UserUncheckedCreateWithoutBalanceInputObjectSchema: z.ZodType<Prisma.UserUncheckedCreateWithoutBalanceInput, Prisma.UserUncheckedCreateWithoutBalanceInput> = z.object({
...
export const UserUncheckedCreateWithoutBalanceInputObjectZodSchema = z.object({
  id: z.string().optional(),
  email: z.string(),
  password: z.string(),
  name: z.string(),
