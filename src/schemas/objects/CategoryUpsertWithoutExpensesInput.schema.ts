...
export const CategoryUpsertWithoutExpensesInputObjectSchema: z.ZodType<
	Prisma.CategoryUpsertWithoutExpensesInput,
	Prisma.CategoryUpsertWithoutExpensesInput
> = z
	.object({
		update: z.union([
	...
	.strict();
export const CategoryUpsertWithoutExpensesInputObjectZodSchema = z
	.object({
		update: z.union([
			z.lazy(() => CategoryUpdateWithoutExpensesInputObjectSchema),
			z.lazy(() => CategoryUncheckedUpdateWithoutExpensesInputObjectSchema),
