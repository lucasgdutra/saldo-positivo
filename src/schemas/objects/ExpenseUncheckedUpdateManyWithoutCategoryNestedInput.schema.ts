...
const makeSchema = (): z.ZodObject<any> =>
	z
		.object({
			create: z
				.union([
					...
					z
						.lazy(() => ExpenseUncheckedCreateWithoutCategoryInputObjectSchema)
						.array(),
				])
				.optional(),
			connectOrCreate: z
				.union([
					...
					z
						.lazy(() => ExpenseCreateOrConnectWithoutCategoryInputObjectSchema)
						.array(),
				])
				.optional(),
			upsert: z
				.union([
					z.lazy(
						() => ExpenseUpsertWithWhereUniqueWithoutCategoryInputObjectSchema,
					),
					z
						.lazy(
							() =>
				...
				.optional(),
			createMany: z
				.lazy(() => ExpenseCreateManyCategoryInputEnvelopeObjectSchema)
				.optional(),
			set: z
				.union([
			...
			update: z
				.union([
					z.lazy(
						() => ExpenseUpdateWithWhereUniqueWithoutCategoryInputObjectSchema,
					),
					z
						.lazy(
							() =>
			...
			updateMany: z
				.union([
					z.lazy(
						() => ExpenseUpdateManyWithWhereWithoutCategoryInputObjectSchema,
					),
					z
						.lazy(
							() => ExpenseUpdateManyWithWhereWithoutCategoryInputObjectSchema,
		...
		.strict();
export const ExpenseUncheckedUpdateManyWithoutCategoryNestedInputObjectSchema: z.ZodType<Prisma.ExpenseUncheckedUpdateManyWithoutCategoryNestedInput> =
	makeSchema() as unknown as z.ZodType<Prisma.ExpenseUncheckedUpdateManyWithoutCategoryNestedInput>;
export const ExpenseUncheckedUpdateManyWithoutCategoryNestedInputObjectZodSchema =
	makeSchema();
