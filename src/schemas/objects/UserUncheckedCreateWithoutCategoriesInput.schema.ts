...
export const UserUncheckedCreateWithoutCategoriesInputObjectSchema: z.ZodType<Prisma.UserUncheckedCreateWithoutCategoriesInput, Prisma.UserUncheckedCreateWithoutCategoriesInput> = z.object({
...
export const UserUncheckedCreateWithoutCategoriesInputObjectZodSchema = z.object({
  id: z.string().optional(),
  email: z.string(),
  password: z.string(),
  name: z.string(),
