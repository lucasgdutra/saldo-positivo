...
export const UserCreateWithoutBalanceInputObjectSchema: z.ZodType<
	Prisma.UserCreateWithoutBalanceInput,
	Prisma.UserCreateWithoutBalanceInput
> = z
	.object({
	...
	.strict();
export const UserCreateWithoutBalanceInputObjectZodSchema = z
	.object({
		id: z.string().optional(),
		email: z.string(),
		password: z.string(),
