...
export const ExpenseCreateNestedManyWithoutUserInputObjectSchema: z.ZodType<
	Prisma.ExpenseCreateNestedManyWithoutUserInput,
	Prisma.ExpenseCreateNestedManyWithoutUserInput
> = z
	.object({
		create: z
	...
	.strict();
export const ExpenseCreateNestedManyWithoutUserInputObjectZodSchema = z
	.object({
		create: z
			.union([
				z.lazy(() => ExpenseCreateWithoutUserInputObjectSchema),
