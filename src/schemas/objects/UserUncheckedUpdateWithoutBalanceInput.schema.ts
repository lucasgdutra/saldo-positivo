...
export const UserUncheckedUpdateWithoutBalanceInputObjectSchema: z.ZodType<
	Prisma.UserUncheckedUpdateWithoutBalanceInput,
	Prisma.UserUncheckedUpdateWithoutBalanceInput
> = z
	.object({
		id: z
	...
	.strict();
export const UserUncheckedUpdateWithoutBalanceInputObjectZodSchema = z
	.object({
		id: z
			.union([
				z.string(),
