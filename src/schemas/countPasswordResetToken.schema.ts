...
export const PasswordResetTokenCountSchema: z.ZodType<Prisma.PasswordResetTokenCountArgs, Prisma.PasswordResetTokenCountArgs> = z.object({ orderBy: z.union([PasswordResetTokenOrderByWithRelationInputObjectSchema, PasswordResetTokenOrderByWithRelationInputObjectSchema.array()]).optional(), where: PasswordResetTokenWhereInputObjectSchema.optional(), cursor: PasswordResetTokenWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), select: z.union([ z.literal(true), PasswordResetTokenCountAggregateInputObjectSchema ]).optional() }).strict();
