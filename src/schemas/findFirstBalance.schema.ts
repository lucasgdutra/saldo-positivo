...
export const BalanceFindFirstSelectSchema: z.ZodType<Prisma.BalanceSelect, Prisma.BalanceSelect> = z.object({
...
export const BalanceFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    totalAmount: z.boolean().optional(),
    totalRevenues: z.boolean().optional(),
    totalExpenses: z.boolean().optional(),
...
export const BalanceFindFirstSchema: z.ZodType<Prisma.BalanceFindFirstArgs, Prisma.BalanceFindFirstArgs> = z.object({ select: BalanceFindFirstSelectSchema.optional(), include: z.lazy(() => BalanceIncludeObjectSchema.optional()), orderBy: z.union([BalanceOrderByWithRelationInputObjectSchema, BalanceOrderByWithRelationInputObjectSchema.array()]).optional(), where: BalanceWhereInputObjectSchema.optional(), cursor: BalanceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BalanceScalarFieldEnumSchema, BalanceScalarFieldEnumSchema.array()]).optional() }).strict();

export const BalanceFindFirstZodSchema = z.object({ select: BalanceFindFirstSelectSchema.optional(), include: z.lazy(() => BalanceIncludeObjectSchema.optional()), orderBy: z.union([BalanceOrderByWithRelationInputObjectSchema, BalanceOrderByWithRelationInputObjectSchema.array()]).optional(), where: BalanceWhereInputObjectSchema.optional(), cursor: BalanceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BalanceScalarFieldEnumSchema, BalanceScalarFieldEnumSchema.array()]).optional() }).strict();