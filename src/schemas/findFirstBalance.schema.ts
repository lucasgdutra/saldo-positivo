...
export const BalanceFindFirstSelectSchema: z.ZodType<Prisma.BalanceSelect> = z
	.object({
...
export const BalanceFindFirstSelectZodSchema = z
	.object({
		id: z.boolean().optional(),
		totalAmount: z.boolean().optional(),
		totalRevenues: z.boolean().optional(),
...
export const BalanceFindFirstSchema: z.ZodType<Prisma.BalanceFindFirstArgs> = z
	.object({
		select: BalanceFindFirstSelectSchema.optional(),
	...
	.strict() as unknown as z.ZodType<Prisma.BalanceFindFirstArgs>;

export const BalanceFindFirstZodSchema = z
	.object({
		select: BalanceFindFirstSelectSchema.optional(),
		include: z.lazy(() => BalanceIncludeObjectSchema.optional()),
		orderBy: z
