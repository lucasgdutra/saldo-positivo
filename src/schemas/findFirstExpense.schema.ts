...
export const ExpenseFindFirstSelectSchema: z.ZodType<Prisma.ExpenseSelect> = z
	.object({
...
export const ExpenseFindFirstSelectZodSchema = z
	.object({
		id: z.boolean().optional(),
		amount: z.boolean().optional(),
		description: z.boolean().optional(),
...
export const ExpenseFindFirstSchema: z.ZodType<Prisma.ExpenseFindFirstArgs> = z
	.object({
		select: ExpenseFindFirstSelectSchema.optional(),
	...
	.strict() as unknown as z.ZodType<Prisma.ExpenseFindFirstArgs>;

export const ExpenseFindFirstZodSchema = z
	.object({
		select: ExpenseFindFirstSelectSchema.optional(),
		include: z.lazy(() => ExpenseIncludeObjectSchema.optional()),
		orderBy: z
