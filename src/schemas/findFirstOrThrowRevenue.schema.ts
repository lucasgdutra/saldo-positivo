...
export const RevenueFindFirstOrThrowSelectSchema: z.ZodType<Prisma.RevenueSelect> =
	z
		.object({
...
export const RevenueFindFirstOrThrowSelectZodSchema = z
	.object({
		id: z.boolean().optional(),
		amount: z.boolean().optional(),
		description: z.boolean().optional(),
...
export const RevenueFindFirstOrThrowSchema: z.ZodType<Prisma.RevenueFindFirstOrThrowArgs> =
	z
		.object({
			select: RevenueFindFirstOrThrowSelectSchema.optional(),
		...
		.strict() as unknown as z.ZodType<Prisma.RevenueFindFirstOrThrowArgs>;

export const RevenueFindFirstOrThrowZodSchema = z
	.object({
		select: RevenueFindFirstOrThrowSelectSchema.optional(),
		include: z.lazy(() => RevenueIncludeObjectSchema.optional()),
		orderBy: z
