...
export const RevenueCountSchema: z.ZodType<Prisma.RevenueCountArgs> = z
	.object({
		orderBy: z
			.union([
	...
	.strict() as unknown as z.ZodType<Prisma.RevenueCountArgs>;

export const RevenueCountZodSchema = z
	.object({
		orderBy: z
			.union([
				RevenueOrderByWithRelationInputObjectSchema,
