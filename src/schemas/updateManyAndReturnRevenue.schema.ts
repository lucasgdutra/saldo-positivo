...
export const RevenueUpdateManyAndReturnSchema = z.object({ select: RevenueSelectObjectSchema.optional(), data: RevenueUpdateManyMutationInputObjectSchema, where: RevenueWhereInputObjectSchema.optional()  }).strict()