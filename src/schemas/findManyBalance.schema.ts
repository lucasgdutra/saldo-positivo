...
export const BalanceFindManySelectSchema: z.ZodType<Prisma.BalanceSelect> = z.object({
...
export const BalanceFindManySchema: z.ZodType<Prisma.BalanceFindManyArgs> = z.object({ select: BalanceFindManySelectSchema.optional(), include: z.lazy(() => BalanceIncludeObjectSchema.optional()), orderBy: z.union([BalanceOrderByWithRelationInputObjectSchema, BalanceOrderByWithRelationInputObjectSchema.array()]).optional(), where: BalanceWhereInputObjectSchema.optional(), cursor: BalanceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BalanceScalarFieldEnumSchema, BalanceScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.BalanceFindManyArgs>;
