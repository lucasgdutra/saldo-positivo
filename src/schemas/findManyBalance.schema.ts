...
export const BalanceFindManySelectSchema: z.ZodType<Prisma.BalanceSelect, Prisma.BalanceSelect> = z.object({
...
export const BalanceFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    totalAmount: z.boolean().optional(),
    totalRevenues: z.boolean().optional(),
    totalExpenses: z.boolean().optional(),
...
export const BalanceFindManySchema: z.ZodType<Prisma.BalanceFindManyArgs, Prisma.BalanceFindManyArgs> = z.object({ select: BalanceFindManySelectSchema.optional(), include: z.lazy(() => BalanceIncludeObjectSchema.optional()), orderBy: z.union([BalanceOrderByWithRelationInputObjectSchema, BalanceOrderByWithRelationInputObjectSchema.array()]).optional(), where: BalanceWhereInputObjectSchema.optional(), cursor: BalanceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BalanceScalarFieldEnumSchema, BalanceScalarFieldEnumSchema.array()]).optional() }).strict();

export const BalanceFindManyZodSchema = z.object({ select: BalanceFindManySelectSchema.optional(), include: z.lazy(() => BalanceIncludeObjectSchema.optional()), orderBy: z.union([BalanceOrderByWithRelationInputObjectSchema, BalanceOrderByWithRelationInputObjectSchema.array()]).optional(), where: BalanceWhereInputObjectSchema.optional(), cursor: BalanceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BalanceScalarFieldEnumSchema, BalanceScalarFieldEnumSchema.array()]).optional() }).strict();