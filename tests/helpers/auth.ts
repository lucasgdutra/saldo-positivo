...
export class AuthHelper {
  ...
  async loginWithSeedUser() {
    ...
    // Fill login form
    await this.page.fill('input[type="email"], input[name="email"]', SEED_USER.email);
    await this.page.fill('input[type="password"], input[name="password"]', SEED_USER.password);
  ...
  async isAuthenticated(): Promise<boolean> {
    ...
    const protectedRoutes = ['/dashboard', '/despesas', '/receitas', '/categorias', '/relatorios', '/perfil'];
