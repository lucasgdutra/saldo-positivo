...
test.describe("Responsive Design", () => {
	...
	test("should maintain usability in landscape mode on tablets", async ({
		page,
	}) => {
	...
	test("should have accessible focus indicators on all screen sizes", async ({
		page,
	}) => {
		for (const { width, height } of viewports.slice(0, 2)) {
